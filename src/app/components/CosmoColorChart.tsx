...
const CHART_ALT =
  "COSMO No. 25 embroidery floss color chart showing 500 solid colors across 20 columns";
...
const ZOOM = {
  src: "/images/floss-cosmo-500-color-chart-zoom-tight-20260710.jpg",
  width: 4000,
  height: 1463,
};
...
const MAX_ZOOM = 4;
const ZOOM_STEP = 0.5;
/** Opening zoom so color numbers are readable (relative to viewport width). */
const INITIAL_ZOOM = 2.5;

export default function CosmoColorChart() {
  ...
  return (
    <>
      <figure className="floss-cosmo-chart">
        <button
          type="button"
          ...
          aria-label="View larger color chart"
        >
          <Image
            src={THUMB.src}
            alt={CHART_ALT}
        ...
        <figcaption className="floss-cosmo-chart-caption">
          Official COSMO® No. 25 color chart — 500 colors arranged by family for
          easy matching and gradation. Click the chart to enlarge and zoom.
        </figcaption>
      </figure>
